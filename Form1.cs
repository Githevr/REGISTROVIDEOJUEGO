...
namespace VideojuegoRegistros
{
    public partial class Form1 : Form
    {
        ...
        {
            {
                DialogResult result = MessageBox.Show("¿Estás seguro de que deseas salir de 'REGISTRO DE VIDEOJUEGOS GAMER'SH'?", "Confirmación", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
